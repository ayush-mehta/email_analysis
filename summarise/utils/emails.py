...
class Email:
    ...
    def query_email_by_timeframe(self, start_time: dt.datetime, end_time: dt.datetime, download_attachments: bool = False):
        ...
        emails = self._fetch_and_parse_email(messages=messages, download_attachments=download_attachments)
        return emails
    ...
    def _fetch_and_parse_email(self, messages: List[str], download_attachments: bool = False) -> List[Dict[str, Any]]:
        ...
        for email_identifier in email_identifiers:
            try:
                ...
                if status != 'OK':
                    raise Exception(f"Error fetching email_identifier {email_identifier} info: {msg_data}")
                ...
                attachments = self._extract_attachments(email_message=email_message, download_attachments=download_attachments)
    ...
    def _extract_attachments(self, email_message, download_attachments: bool = False):
        ...
        if email_message.is_multipart():
            for part in email_message.walk():
                ...
                if 'attachment' in content_disposition or (content_disposition == '' and part.get_filename()):
                    ...
                    if filename:
                        ...
                        attachments.append({
                            ...
                            'content_base64': self._encode_base64(file_content) if file_content else None
                        })
